...
<html lang="en">
    ...
    <main>
        <div class="container my-5">
            <h1 class="text-center">BTTH01 bài 2</h1>
            <p class="text-center">Xây dựng trang web dạng bài thi trắc nghiệm và đọc từ file .txt</p>
        </div>
    </main>
        ...
        <div class="row text-white" id="fut">
            ...
            <div class="col-6">
                <div class="content d-flex my-3">
                    <img class="card-img-top mt-2 mx-2 mb-2" src="images/robot.png" alt="Logo" width="80" />
