...
<body>
    ...
    <main>
        <div class="container">
            <div class="row">
                <div class="col-1">
                    <a href=""><img src="images/—Pngtree—creative company_1420804.png" class="img-fluid rounded-top"
                            alt="" />
                    </a>
                </div>
            ...
            <div class="row">
                <ul class="nav" id="navs">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-light" href="">Khám phá Địa phương</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="">Top 10 loài hoa</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link text-light" href="">Ẩm thực du lịch</a>
                    </li>
                    <li class="nav-item">
