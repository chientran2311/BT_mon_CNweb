...
<html lang="en">
    ...
    <main>
        <div class="container my-5">
            <h1 class="text-center">BTVN buổi 1</h1>
            <p class="text-center">Xây dựng trang web dạng CRUD bằng php và phân chia thành các components</p>
        </div>
    </main>
        ...
        <div class="row text-white" id="fut">
            ...
            <div class="col-6">
                <div class="content d-flex my-3">
                    <img class="card-img-top mt-2 mx-2 mb-2" src="../image/robot.png" alt="Logo" width="80" />
